...
app.layout = html.Div(
    [
        ...
        html.H1(
            "Automobile Sales Statistics Dashboard",  # May include style for title
    ...
    # Yearly Statistic Report Plots
        ...
        Y_chart2 = dcc.Graph(
            figure=px.line(
                ...
                x="Month",
                y="Automobile_Sales",
                title="Total Monthly Automobile Sales for the Year {}".format(
                    input_year
                ),
            )
        )
        ...
        Y_chart4 = dcc.Graph(
            figure=px.pie(
                ...
                values="Advertising_Expenditure",
                names="Vehicle_Type",
                title="Advertisement Expenditure by Vehicle Type for the Year {}".format(
                    input_year
                ),
            )
        )
